...
{
   partial class Xrpt_ReportDSCTVT
   {
      /// <summary>
      ...
      private void InitializeComponent()
      {
         ...
         System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Xrpt_ReportDSCTVT));
         ...
         this.taReport_DSCTVT = new QLVT_DATHANG.DataSetReportTableAdapters.Report_DSCTVTTableAdapter();
         ...
         storedProcQuery1.Name = "Report_DSCTVT";
         queryParameter1.Name = "@LOAI";
         queryParameter1.Type = typeof(char);
         queryParameter2.Name = "@BEGIN";
         ...
         storedProcQuery1.StoredProcName = "Report_DSCTVT";
         ...
         this.BottomMargin.Controls.AddRange(new DevExpress.XtraReports.UI.XRControl[] {
            this.pageInfo1,
            this.pageInfo2});
         this.BottomMargin.HeightF = 205.75F;
         ...
         this.label1.Text = "BẢNG KÊ CHI TIẾT SỐ LƯỢNG - TRỊ GIÁ HÀNG ___";
         // 
         // table1
         // 
         ...
         // 
         this.taReport_DSCTVT.ClearBeforeFill = true;
         // 
         // Xrpt_ReportDSCTVT
         // 
         ...
         this.ComponentStorage.AddRange(new System.ComponentModel.IComponent[] {
            this.sqlDataSource,
            this.dataSetReport});
         this.DataAdapter = this.taReport_DSCTVT;
         this.DataMember = "Report_DSCTVT";
         this.DataSource = this.dataSetReport;
         this.Font = new System.Drawing.Font("Arial", 9.75F);
         this.Margins = new System.Drawing.Printing.Margins(100, 100, 100, 206);
      ...
      private DataSetReportTableAdapters.Report_DSCTVTTableAdapter taReport_DSCTVT;
   }
}
